...
{/* drop down nav */}
    ...
    <>
      <li tabIndex={0} className="z-10">
        <details>
            <summary>Course & Note</summary>
        
       
            <ul className="w-52">
                {
                    user && <>
                    <li><NavLink to="/addCourse" className={({ isActive, isPending }) =>isPending ? "pending": isActive ? "underline md:no-underline bg-inherit md:bg-slate-800 md:py-[6px] px-3 font-semibold rounded-md text-cyan-600 md:text-white" : "" }>Add Course</NavLink></li>
                    </>
                }
